package com.paipianwang.service.fastdfs.component;
...
import com.paipianwang.service.fastdfs.utils.ConnectionPool;
...
public class FastDFSClient {
	...
	public StorageClient1 loadClient() {
		...
		try {
			...
			client1 = new StorageClient1(trackerServer,  
					storageServer);
			trackerServer = pool.checkout(logId);
	...
	public String uploadFile(File file, String fileName) {
		...
		try {
            ...
            StorageClient1 client1 = new StorageClient1(trackerServer,  
                    storageServer);
			String fileid = client1.upload_file1(file_buff, FileUtil.getFileExt(fileName), meta_list);
	...
	public String uploadFile(MultipartFile file) {
		...
		try {
			...
			if(fis != null ) {
	            ...
	            StorageClient1 client1 = new StorageClient1(trackerServer,  
	                    storageServer);
				String fileid = client1.upload_file1(file_buff, FileUtil.getFileExt(file.getOriginalFilename()), meta_list);
				return fileid;
			}
			return null;
		} catch (Exception ex) {
