...
public class FastDFSBiz {
	...
	/**
	 * 删除文件 根据fileId来删除一个文件（我们现在用的就是这样的方式，上传文件时直接将fileId保存在了数据库中）
	 * 
	 * @param fileId
	 ...
	 * 
	 * @param fileId
	 *            源码中的解释file_id the file id(including group name and
	 *            filename);例如
	 *            group1/M00/00/00/ooYBAFM6MpmAHM91AAAEgdpiRC0012.xml
	 ...
	 * 获取当前最优的文件存储节点服务器
	 * 
	 * @return 当前最优文件存储节点IP地址 (如果为null，说明没有找到存储节点，返回IP地址则成功)
	 */
