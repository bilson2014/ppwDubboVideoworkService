package com.paipianwang.service.fastdfs.utils;
...
public class ConnectionPool {
	...
	//private static final String CONF_FILENAME = "D:\\fdfs_client.conf";
	
	//private static final String CONF_FILENAME = ConnectionPool.class.getResource("fdfs_client.conf").getPath();
